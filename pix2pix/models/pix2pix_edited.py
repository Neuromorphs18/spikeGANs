...
class Pix2PixModel(BaseModel):
    ...
    def __init__(self, opt, train=False):
        ...
        # MR EDIT ---------------------------
        self.seq_depth = opt.seq_depth

        self.gru1 = nn.GRU(opt.fineSize**2 + 1, 500) # x * y + 1 (==)
        self.gru2 = nn.GRU(opt.fineSize**2, 500) # x, y, pol, don't send
